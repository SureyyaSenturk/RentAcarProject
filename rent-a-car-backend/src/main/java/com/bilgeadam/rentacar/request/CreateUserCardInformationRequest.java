...
@AllArgsConstructor
@NoArgsConstructor
public class CreateUserCardInformationRequest extends BaseRequest {

  @Pattern(
      regexp = "^[0-9]{16}",
      message = BusinessMessages.PaymentRequestsMessages.CARD_NO_REGEX_MESSAGE)
  ...
  @Range(
      min = 1,
      max = 12,
      message = BusinessMessages.PaymentRequestsMessages.EXPIRATION_MONTH_REGEX_MESSAGE)
